...
const createSchema = z.object({ mode: z.enum(["AUTO", "KNOWLEDGE", "GENERAL", "WEB", "COMBINED"]).default("AUTO"), title: z.string().trim().max(160).optional(), webSearch: z.boolean().optional(), reasoning: z.boolean().optional() }).strict();
